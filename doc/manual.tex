...
``C4-G#6'' or open-ended ranges like ``-E3'' will match ranges of
...
\item[--input \textit{port}] sets the name of the input MIDI port to
  use for receiving incoming MIDI events.  You can retrieve a list of
  possible ports using the {\tt --list} option.

\item[--output \textit{port}] sets the name of the output MIDI port to
